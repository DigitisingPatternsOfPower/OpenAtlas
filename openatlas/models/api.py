...
class Api:
    ...
    def get_entity(id_: int) -> str:
        ...
        data = {
            ...
            "feature": [{"@id": url_for('place_view', id_=entity.id, _external=True),
                         ...
                         "geometry": {
                             ...
                             "geometries": [{
                                 "type": "Point",
                                 "coordinates": [15.643286705017092,
                                                 48.586735522177],
                         ...
                         #                 # Hab ich hinzugefügt, müssen wir noch reden
                         ...
                         #     ]
                         # },
                         "names": [{"toponym": entity.name}],
                         "types": [{"identifier": "",  # URI vom Type
